...
taskkill /F /IM BgKeyDesk.exe >nul 2>&1
timeout /t 2 /nobreak >nul

if exist "dist\BgKeyDesk.exe" (
  del /f /q "dist\BgKeyDesk.exe" >nul 2>&1
)
if exist "dist\BgKeyDesk.exe" (
  echo [ERROR] Cannot replace dist\BgKeyDesk.exe
...
echo.
echo OK
echo EXE: "%cd%\dist\BgKeyDesk.exe"
echo.
if exist "dist\BgKeyDesk.exe" explorer dist
pause
